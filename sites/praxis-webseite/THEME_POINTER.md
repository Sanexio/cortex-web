...
## Aktueller Theme-Stand (Stand 2026-04-22 nach S2.3-diagnostik)

| Eintrag | Wert |
|---------|------|
| Commit-Hash | `25662ad` (auf `c090173` → `e2336e2` → `c7acaf7` → `058b062` → `15cf331` → `70d1b29` → `ae9b1b8` folgend) |
| Commit-Message | `feat(s2.3-diagnostik): cluster hub + 4 top categories + 3 nested sono children (PXZ 2.7.18)` |
| PXZ_VERSION | `2.7.18` |
